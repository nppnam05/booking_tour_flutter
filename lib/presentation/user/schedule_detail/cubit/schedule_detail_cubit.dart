...
class ScheduleDetailCubit extends Cubit<ScheduleDetailState> {
  ...
  ScheduleDetailCubit() : super(ScheduleDetailState(daySelected: 1, scheduleDetail: ScheduleDetail.empty()));
  ...
  Future<void> getData(int id) async {
    ...
    schedule.fold((failure){
      ...
      emit(state.copyWith(scheduleDetail: schedule, daySelected: 1));
    });
  }
