...
class _SelectionDialogState<T> extends State<SelectionDialog<T>> {
  ...
  late List<T> _filteredItems = List<T>.from(widget.items);
  late final Set<T> _selected = widget.preSelectedItems.toSet();
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        color: selected
                            ? const Color(0xFFDDEEDB) // light green bg
                            : null,
                        ...
                        : () {
                            if (widget.isMultiSelect) {
                              Navigator.of(context)
                                  .pop<List<T>>(_selected.toList());
                            } else {
                              Navigator.of(context)
                                  .pop<T>(_selected.first);
                            }
                          },
                  ),
